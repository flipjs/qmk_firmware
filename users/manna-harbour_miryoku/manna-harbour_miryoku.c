...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = LAYOUT_miryoku(
    ...
    LSFT_T(KC_Z),      LGUI_T(KC_X),      LCTL_T(KC_C),      LALT_T(KC_V),      MEH_T(KC_B),       MEH_T(KC_N),       LALT_T(KC_M),      LCTL_T(KC_COMM),   LGUI_T(KC_DOT),    LSFT_T(KC_SLSH),
  ...
  [NAVR] = LAYOUT_miryoku(
    ...
    KC_LSFT, KC_LGUI, KC_CAPS, KC_LALT, KC_MEH,  KC_NP,   KC_NP,   KC_NP,   KC_NP,   KC_MUTE,
  ...
  [MOUR] = LAYOUT_miryoku(
    ...
    KC_LSFT, KC_LGUI, KC_CAPS, KC_LALT, KC_MEH,  KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_NU,
  ...
  [MEDR] = LAYOUT_miryoku(
    ...
    KC_LSFT, KC_LGUI, KC_CAPS, KC_LALT, KC_MEH,  KC_NU,   KC_NU,   KC_NU,   KC_NU,   KC_NU,
  ...
  [FUNL] = LAYOUT_miryoku(
    ...
    KC_PAUS,  KC_F7,   KC_F8,   KC_F9,   KC_F10, KC_MEH,  KC_LALT, KC_CAPS, KC_LGUI, KC_LSFT,
  ...
  [NSL] = LAYOUT_miryoku(
    ...
    KC_GRV,  KC_7,    KC_8,    KC_9,    KC_0,    KC_MEH,  KC_LALT, KC_CAPS, KC_LGUI, KC_LSFT,
  ...
  [NSSL] = LAYOUT_miryoku(
    ...
    KC_TILD, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_MEH,  KC_LALT, KC_CAPS, KC_LGUI, KC_LSFT,
