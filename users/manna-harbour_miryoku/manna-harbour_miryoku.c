...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = LAYOUT_miryoku(
    ...
    LSFT_T(KC_Z),      LALT_T(KC_X),      LCTL_T(KC_C),      LGUI_T(KC_V),      MEH_T(KC_B),       MEH_T(KC_N),       LGUI_T(KC_M),      LCTL_T(KC_COMM),   LALT_T(KC_DOT),    LSFT_T(KC_SLSH),
  ...
  [NAVR] = LAYOUT_miryoku(
    ...
    KC_LSFT, KC_LALT, KC_LCTL, KC_LGUI, KC_MEH,  KC_NP,   KC_NP,   KC_NP,   KC_NP,   KC_MUTE,
  ...
  [MOUR] = LAYOUT_miryoku(
    ...
    KC_LSFT, KC_LALT, KC_LCTL, KC_LGUI, KC_MEH,  KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_NU,
  ...
  [MEDR] = LAYOUT_miryoku(
    ...
    KC_LSFT, KC_LALT, KC_LCTL, KC_LGUI, KC_MEH,  KC_NU,   KC_NU,   KC_NU,   KC_NU,   KC_NU,
  ...
  [FUNL] = LAYOUT_miryoku(
    ...
    KC_NP,    KC_NP,   KC_CAPS, KC_SPC,  KC_SPC, KC_NA,   KC_NA,   KC_NA,   KC_NP,   KC_NP
  ),
  [NSL] = LAYOUT_miryoku(
