...
[NAVR] = LAYOUT_miryoku(
KC_ESC,      KC_NA,       KC_UP,          KC_NA,         KC_NA,   KC_NA,         KC_NA,    KC_NA,    KC_NA,    KC_NA,
LGUI(KC_A),  KC_LEFT,     KC_DOWN,        KC_RIGHT,      KC_NA,   KC_LEFT,       KC_DOWN,  KC_UP,    KC_RGHT,  KC_NA,
...
[FUNL] = LAYOUT_miryoku(
KC_PSCR,  KC_F1,  KC_F2,    KC_F3,    KC_F10,   KC_NA,    KC_NA,    KC_NA,    KC_NA,  KC_CAPS,
KC_SLCK,  KC_F4,  KC_F5,    KC_F6,    KC_F11,   KC_NA,    KC_NA,    KC_NA,    KC_NA,  KC_NA,
KC_PAUS,  KC_F7,  KC_F8,    KC_F9,    KC_F12,   KC_NA,    KC_NA,    KC_NA,    KC_NA,  RESET,
KC_NP,    KC_NP,  KC_MPRV,  KC_MNXT,  KC_MPLY,  KC_MUTE,  KC_VOLD,  KC_VOLU,  KC_NP,  KC_NP
)
};
