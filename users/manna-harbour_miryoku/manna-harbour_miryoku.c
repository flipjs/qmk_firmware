...
KC_NP,       KC_NP,       MO(NSSL),           MO(NSL),           LT(NAVR,KC_SPC),    LT(NAVR,KC_ENT),    MT(MOD_LCTL,KC_BSPC),  KC_LSFT,    KC_NP,    KC_NP
),
[NAVR] = LAYOUT_miryoku(
KC_MUTE,        KC_VOLD,       KC_UP,       KC_VOLU,       KC_MPRV,  KC_NA,    KC_NA,    KC_NA,    KC_NA,    KC_NA,
LGUI(KC_A),     KC_LEFT,       KC_DOWN,     KC_RIGHT,      KC_MPLY,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  KC_NA,
